...
export default function FilesPage() {
	...
	const assignedSourceFiles = user.role === "designer" ? orders.filter((order) => order.designer === user.name && order.fileUrl) : [];
